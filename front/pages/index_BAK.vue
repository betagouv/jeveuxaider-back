  ...
  <div>
    <div class="relative bg-[#070191] overflow-hidden z-10">
      ...
      >
        ...
        <div class="mt-5">
          <button
            class="mx-auto font-bold cursor-pointer flex items-center shadow-lg justify-center border border-transparent text-2xl leading-6 rounded-full text-white bg-jva-green py-4 px-10 pb-5 hover:shadow-lg hover:scale-105 transform transition"
        ...
        <div class="max-w-[1280px] mx-auto grid gap-6 lg:grid-cols-2">
          ...
          >
            ...
            >
              ...
              <button
                class="w-full sm:w-auto flex items-center justify-center px-6 py-3 font-medium rounded-full shadow-lg text-white bg-jva-green hover:text-white mt-3 sm:mt-0 sm:ml-3 sm:flex-shrink-0 hover:scale-105 transform transition"
