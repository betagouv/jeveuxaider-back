              ...
              >
                <div class="rounded-full shadow-lg">
                  <nuxt-link
                    ...
                    class="flex items-center justify-center px-8 py-3 border border-transparent text-base leading-6 font-medium rounded-full text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring transition duration-150 ease-in-out md:py-4 md:text-lg md:px-10"
                  >
          ...
          >
            ...
            >
              <img
                class="h-14"
                alt="Saint-Maurice"
                src="@/assets/images/saint-maurice.png"
              />
            </div>
            <div
              class="col-span-1 flex justify-center md:col-span-2 lg:col-span-1"
            ...
            >
              <img
                class="h-14"
                alt="Pays de Grasse"
                src="@/assets/images/logo-pays-grasse.png"
              />
            </div>
            <div
            ...
            >
              <img
                class="h-14"
                alt="Soissons"
                src="@/assets/images/soissons.png"
              />
            </div>
          </div>
        </div>
                ...
                <div class="flex">
                  <div class="flex-shrink-0">
                    ...
                    >
                      <img
                        class="h-7"
                        src="@/assets/images/treehouse.svg"
                        alt=""
                      />
                    </div>
                  </div>
