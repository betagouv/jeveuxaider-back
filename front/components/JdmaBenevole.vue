    ...
    <div v-if="showBanner" id="jdma" class="bg-blue-800">
      <div class="container mx-auto py-3 px-3 sm:px-6 lg:px-8">
        ...
        >
          <button
            type="button"
            class="flex p-2 rounded-md focus:outline-none focus:text-indigo-500 transition ease-in-out duration-150"
            @click="handleClose()"
          >
            <svg
...
export default {
  ...
  methods: {
    handleClick() {
      window.open(
        'https://voxusagers.numerique.gouv.fr/Demarches/2603?&amp;view-mode=formulaire-avis&amp;nd_mode=en-ligne-enti%C3%A8rement&amp;nd_source=button&amp;key=e67467d2b689f586a1f53d9e03d92434',
        '_blank'
      )
