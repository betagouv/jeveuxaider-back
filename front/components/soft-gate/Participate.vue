<template>
  <div>
    ...
    <div class="mx-auto max-w-sm">
      ...
      >
        <el-form-item class="mb-5" prop="content" label="Votre message">
          <textarea
        ...
        <el-button
          :loading="loading"
          class="font-bold max-w-sm mx-auto w-full flex items-center justify-center px-5 py-3 border border-transparent text-xl leading-6 rounded-full text-white bg-[#16a972] hover:bg-[#0e9f6e] focus:outline-none focus:ring transition duration-150 ease-in-out mt-8"
