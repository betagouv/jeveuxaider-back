        ...
        <template v-if="cities.length">
          ...
          <div class="mt-12 flex flex-wrap gap-4 items-center justify-center">
            <nuxt-link
              ...
              :key="city.zipcode"
              class="leading-none truncate px-8 py-4 rounded-full text-sm shadow-md font-extrabold tracking-wide uppercase bg-white text-gray-800 transform transition duration-150 ease-in-out will-change-transform hover:scale-105"
