...
export default {
  ...
  methods: {
    iconPublicType(publicType) {
      switch (publicType) {
        case 'seniors':
          return require('@/assets/images/icones/personnes_agees.svg?raw')

        case 'persons_with_disabilities':
          return require('@/assets/images/icones/handicap.svg?raw')

        case 'people_in_difficulty':
          return require('@/assets/images/icones/helping_hand.svg?raw')

        case 'parents':
          return require('@/assets/images/icones/parents.svg?raw')

        case 'children':
          return require('@/assets/images/icones/jeunes_enfants.svg?raw')

        case 'any_public':
          return require('@/assets/images/icones/tous_public.svg?raw')
      }
    },
    goTo(url) {
