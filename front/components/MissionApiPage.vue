              ...
              <div class="py-8 px-6 lg:p-12">
                ...
                <div class="mt-6">
                  <a
                    ...
                    target="_blank"
                    class="max-w-sm mx-auto w-full flex items-center justify-center border border-transparent rounded-full text-white bg-[#16a972] hover:bg-[#0e9f6e] focus:outline-none focus:ring transition duration-150 ease-in-out font-bold text-md sm:text-xl px-5 py-3 pb-4"
                    >Je propose mon aide
                    <svg
        ...
        <div class="bg-white rounded-lg shadow-lg">
          ...
          <div class="py-12 px-6">
            <a
              :href="mission.application_url"
              target="_blank"
              class="mx-auto w-full sm:w-80 flex items-center justify-center border border-transparent rounded-full text-white bg-[#16a972] hover:bg-[#0e9f6e] focus:outline-none focus:ring transition duration-150 ease-in-out font-bold text-md sm:text-xl px-5 py-3 pb-4"
              >Je propose mon aide
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-4 w-4 ml-2"
