...
export default {
  ...
  computed: {
    btnClasses() {
      const classes =
        'max-w-sm mx-auto w-full flex items-center justify-center border border-transparent rounded-full text-white bg-[#16a972] hover:scale-105 !outline-none focus:scale-105 transition font-extrabold text-xl px-5 py-3 pb-4 transform will-change-transform'
