...
class StructureCollectivityValidated extends Notification
{
    ...
    public function toMail($notifiable)
    {
        $mailMessage = (new MailMessage)
            ...
            ->line(new HtmlString("Pour vous inscrire, c'est par ici 👉 : <a href='https://app.livestorm.co/jeveuxaider/session-decouverte-collectivites-territoriales'>https://app.livestorm.co/jeveuxaider/session-decouverte-collectivites-territoriales</a>"))
