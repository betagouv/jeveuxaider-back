...
class StructureWaitingValidation extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line('Avant tout, merci d\'avoir rejoint JeVeuxAider !')
            ...
            ->line('Vous pouvez dès maintenant proposer une ou plusieurs missions. Elles seront publiées dès la validation de votre organisation par le référent de JeVeuxAider de votre département.')
        ;
    }
