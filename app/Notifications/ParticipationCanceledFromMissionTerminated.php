...
class ParticipationCanceledFromMissionTerminated extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct(Participation $participation)
    {
        ...
        $this->tag = 'app-benevole-participation-canceled-mission-terminated';
    }
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage())
            ...
            ->markdown('emails.benevoles.participation-canceled-mission-terminated', [
