...
class MissionSignaled extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line('Votre mission « ' . $this->mission->name . ' » ne répond pas aux éxigences de la Charte de la Réserve Civique et/ou aux règles fixés par le Décret n° 2017-930 du 9 mai 2017 relatif à la réserve civique.')
