...
class MissionSubmitted extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line('La structure « ' . $this->mission->structure->name . ' » propose une mission dans le cadre de la crise sanitaire : ' . $this->mission->name)
