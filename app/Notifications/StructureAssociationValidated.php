...
class StructureAssociationValidated extends Notification implements ShouldQueue
{
    ...
    public function __construct($structure)
    {
        ...
        $this->tag = 'app-responsable-association-validee';
    }
    ...
    public function toMail($notifiable)
    {
        $mailMessage = (new MailMessage())
            ...
            ->line(new HtmlString('Vous venez de rejoindre la plateforme <a href="' . $this->trackedUrl("") . '">JeVeuxAider.gouv.fr</a> proposée par la Réserve Civique : bienvenue ! Toute l’équipe est ravie de vous compter parmi les 5000 organisations membres.'))
            ...
            ->action('Créer une mission', $this->trackedUrl('/admin/organisations/' . $this->structure->id) . '/missions/add')
