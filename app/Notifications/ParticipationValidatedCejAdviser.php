...
class ParticipationValidatedCejAdviser extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        $message = (new MailMessage())
            ...
            ->greeting('Bonjour,')
            ->line(new HtmlString($this->participation->profile->full_name . ', que vous accompagnez dans le cadre du Contrat d’Engagement Jeune, s’est inscrit sur la mission <a href="' . $this->trackedUrl($this->participation->mission->full_url) . '">' . $this->participation->mission->name . '</a>.'))
