...
class RegisterUserVolontaire extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line('Vous vous êtes inscrit sur JeVeuxAider.gouv.fr, la plateforme publique du bénévolat. Voici une sélection de missions réalisables à coté de chez vous ou à distance :')
