...
class NotificationToBenevole extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line("L'association {$this->notificationBenevole->mission->structure->name} vous propose une nouvelle mission de bénévolat sur le domaine d'action **{$this->notificationBenevole->mission->domaines[0]}**.")
            ->line("Votre profil correspond à celui des volontaires recherchés.")
            ->line("")
            ->line("La mission :")
