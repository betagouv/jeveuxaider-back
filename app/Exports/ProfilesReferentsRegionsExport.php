...
class ProfilesReferentsRegionsExport implements FromCollection, WithMapping, WithHeadings
{
    ...
    */
    public function collection()
    {
        return QueryBuilder::for(Profile::class)
            ->allowedAppends('roles', 'has_user', 'skills', 'domaines', 'referent_region_waiting_actions')
            ->allowedFilters(
    ...
    public function map($profile): array
    {
        return [
            ...
            $profile->referent_region_waiting_actions['structures'],
            $profile->referent_region_waiting_actions['missions'],
