...
class Airtable
{
    ...
    private static function formatStructureAttributes(Structure $structure)
    {
        $attributes = [
            ...
            'Taux de réponse' => $structure->score->processed_participations_rate / 100,
            'Temps de réponse' => $structure->score->response_time / (60 * 60 * 24),
            'Score de réactivité' => $structure->score->total_points,
