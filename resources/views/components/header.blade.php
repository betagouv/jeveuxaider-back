<header>
    ...
    <div class="bg-primary pb-32">
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap items-center justify-center md:h-16 border-b border-[#070191]">
                <div class="flex-shrink-0 my-4 md:my-0">
                    <a href="/">
                        <img class="h-6" src="@/assets/images/logo-header.png" alt="JeVeuxAider.gouv.fr" />
                    </a>
                </div>
