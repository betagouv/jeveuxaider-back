@component('mail::message')
    @component('mail::components.headline')
        Votre mission a été mise hors ligne 😢
    @endcomponent
    ...
    @component('mail::components.paragraph')
        ...
        <p>Pour éviter d’avoir de nouvelles participations à mettre à jour, la mission a été ponctuellement mise hors ligne. Elle n’est plus visible depuis la recherche, et les bénévoles ne peuvent plus proposer leur aide.</p>
