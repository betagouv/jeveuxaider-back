@component('mail::message')
    ...
    @component('mail::components.paragraph')
        <p>Il y a 6 mois, vous vous êtes inscrits sur <a class="link" href="{{ $urlHome }}">JeVeuxAider.gouv.fr</a>, la plateforme publique du bénévolat. On se dit que peut être, vous n’avez pas trouvé votre bonheur. 💔 Pourtant on est sûr d’avoir la mission faites pour vous, parmi les 18 000 en ligne, en ce moment même.</p>
