@component('mail::message')
    @component('mail::components.headline')
        🙌 Ça y est ! Vous pouvez proposer votre aide pour la mission :
    @endcomponent
    @component('mail::components.paragraph')
        <a class="link" href="{{ $url }}">{{ $mission->name }}</a>
    @endcomponent
    ...
    @component('mail::components.tips')
        <p>Ne l’oubliez pas, lorsque vous proposez votre aide sur une mission, les organisations comptent sur vous. Si vous ne pouvez plus y participer, il suffit de les prévenir à l’aide de la messagerie.</p>
