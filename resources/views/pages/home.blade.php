...
@section('content')
    ...
    <div class="lg:flex">
        <div class="lg:w-1/2"><img class="object-cover object-center w-full h-full" src="/images/brainstorming.jpeg" alt="" /></div>
    ...
    <div class="lg:flex">
        ...
        <div class="lg:w-1/2"><img class="object-cover object-center w-full h-full" src="/images/volontaires.jpeg" alt="" /> </div>
    </div>
    ...
    <div class="lg:flex">
        <div class="bg-blue-700 text-white lg:w-1/2 px-4 py-8 md:px-8 md:py-12 lg:px-12 lg:py-16">
            <div class="lg:max-w-xl flex flex-col items-center text-center lg:items-start lg:text-left lg:ml-auto">
                ...
                <div class="mt-3">
                    <a href="https://www.gouvernement.fr/info-coronavirus" target="_blank" class="btn-secondary plain">S'informer</a>
                </div>
            </div>
        </div>
