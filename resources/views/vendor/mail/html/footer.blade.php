                ...
                <tr>
                    <td align="center" valign="top">
                        <table cellpadding="0" cellspacing="0" border="0" width="78%" style="min-width: 300px;">
                            <tr>
                                <td align="center" valign="top" width="23%">
                                    <a href="https://www.jeveuxaider.gouv.fr/missions-benevolat" target="_blank"
                                ...
                                <td align="center" valign="top" width="23%">
                                    <a href="https://reserve-civique.crisp.help/fr/" target="_blank"
                                        style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 14px; line-height: 20px; text-decoration: none; white-space: nowrap; font-weight: bold;">
                                        <font face="'Source Sans Pro', sans-serif" color="#1a1a1a"
                                            style="font-size: 14px; line-height: 20px; text-decoration: none; white-space: nowrap; font-weight: bold;">
                                            <span
                                                style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 14px; line-height: 20px; text-decoration: none; white-space: nowrap; font-weight: bold;">Foire
                                                aux questions</span>
                                        </font>
                                    </a>
                                </td>
                                ...
                                <td align="center" valign="top" width="23%">
                                    <a href="https://www.jeveuxaider.gouv.fr/profile" target="_blank"
                                        style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 14px; line-height: 20px; text-decoration: none; white-space: nowrap; font-weight: bold;">
                                        <font face="'Source Sans Pro', sans-serif" color="#1a1a1a"
                                            style="font-size: 14px; line-height: 20px; text-decoration: none; white-space: nowrap; font-weight: bold;">
                                            <span
                        ...
                        <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td align="center" valign="top">
                                    <a href="https://www.instagram.com/jeveuxaider_gouv/?hl=fr" target="_blank"
                                ...
                                <td width="45" style="width: 45px; max-width: 45px; min-width: 45px;">
                                    &nbsp;</td>
                                <td align="center" valign="top">
                                    <a href="https://fr-fr.facebook.com/jeveuxaider.gouv.fr/" target="_blank"
                                ...
                                <td width="45" style="width: 45px; max-width: 45px; min-width: 45px;">
                                    &nbsp;</td>
                                <td align="center" valign="top">
                                    <a href="https://twitter.com/ReserveCivique" target="_blank"
                                ...
                                <td width="45" style="width: 45px; max-width: 45px; min-width: 45px;">
                                    &nbsp;</td>
                                <td align="center" valign="top">
                                    <a href="https://fr.linkedin.com/company/jeveuxaider-gouv-fr" target="_blank"
                                        style="display: block; max-width: 25px;">
                                        <img src="{{ config('app.front_url') }}/images/mail/linkedin.png"
                                            alt="img" width="18" border="0"
