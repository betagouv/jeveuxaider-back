  ...
  >
    <div class="w-full max-w-2xl my-12">
      ...
      <div class="text-gray-600">
        La plateforme de la Réserve Civique est destinée aux référents
        départementaux et aux responsables d'associations. Vous pouvez remonter
        des axes d'améliorations en nous faisant vos retours à l'adresse mail
        suivante: contact@reserve-civique.beta.gouv.fr
      </div>
      <div class="my-12">
        <div
