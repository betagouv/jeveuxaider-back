    ...
    <div class="p-4 sm:p-12">
      ...
      >
        ...
        <item-description>
          ...
          figure dans le menu déroulant du champ ci-dessous, sélectionnez-le.
          Vous permettrez au superviseur de votre réseau de visualiser les
          missions et bénévoles rattachés à votre structure. Vous faciliterez
          également la validation de votre structure par les autorités
