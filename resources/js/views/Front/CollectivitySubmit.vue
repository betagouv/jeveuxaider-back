  ...
  <div>
    ...
    <div class="bg-blue-900 pb-12">
      <div class="container mx-auto px-4">
        <div class="pt-10">
          <h1 class="text-3xl font-bold text-white">Appel aux collectivités</h1>
        </div>
      </div>
    </div>
    ...
    <div class="bg-blue-900">
      <div class="container mx-auto pb-64 pt-16 px-4">
        <div class="max-w-6xl mx-auto text-center">
          ...
          >Connectez les structures et leurs futurs bénévoles</h2>
          <p
            class="text-xl leading-8 text-indigo-200 mt-2"
          >Équilibrez l'offre et la demande sur votre territoire grâce à une plateforme ludique et gratuite</p>
        </div>
        ...
        <div class="mt-10 text-center sm:max-w-3xl sm:mx-auto sm:grid sm:grid-cols-3 sm:gap-8">
          ...
          <div class="mt-10 sm:mt-0">
            <p class="mt-2 text-lg leading-8 font-medium text-indigo-200">Un taux moyen de</p>
            <p class="text-4xl leading-none font-extrabold text-white">65%</p>
            <p class="mt-2 text-lg leading-6 font-medium text-indigo-200">de remplissage de missions</p>
          </div>
        </div>
      </div>
    </div>
