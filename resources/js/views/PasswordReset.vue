  ...
  <div class="mx-auto w-full" style="max-width: 390px;">
    ...
    <div v-if="!submitted">
      ...
      >
        <el-form-item label="Nouveau mot de passe" prop="password">
          <el-input v-model="form.password" placeholder="Définir un mot de passe" show-password />
        </el-form-item>
        <el-form-item label="Confirmez votre nouveau mot de passe" prop="password_confirmation">
          <el-input
    ...
    <div v-else>
      <div class="mb-6 text-sm">
        ...
        <br />
        <br />Vous pouvez désormais vous connecter avec vos nouveaux identifiants.
      </div>
