    ...
    <div class="mt-12">
      ...
      <div class="mt-8">
        <div class="ml-3 text-gray-700">
          <div class>Sur la base des besoins exprimés par les personnes les plus fragiles :</div>
          <ul class="my-3">
            <li>- je fais leurs courses ;</li>
            <li>- je dépose les sacs devant leur porte et évite tout contact.</li>
          </ul>
          <div
            class="mt-3"
