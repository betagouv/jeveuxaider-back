    ...
    <div class="mt-12">
      ...
      <div class="mt-8">
        <p class="ml-3 text-gray-700">
          ...
          doivent accéder aux biens qui leur sont vitaux au quotidien. Les
          associations d’aide alimentaire et non alimentaire ainsi que les
          associations de lutte contre l’exclusion et la pauvreté ont besoin de
          la mobilisation citoyenne pour assurer la continuité de toutes ces
          activités essentielles. Ce besoin s’étend aux établissement hôteliers
    ...
    <div class="mt-12">
      ...
      <div class="mt-8">
        <div class="ml-3 text-gray-700">
          <div class="">
            Je me rends sur le site de l’association de fourniture de biens de
            première nécessité et participe notamment à :
          </div>
          <ul class="my-3">
            ...
            <li>
              - la préparation des espaces pour les repas en appliquant les
              règles de sécurisation sanitaire ;
            </li>
            <li>
              - le déconditionnement et la cuisine des produits : préparation,
              cuisson … ;
            </li>
