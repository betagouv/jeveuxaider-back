    ...
    <div class="mt-12">
      ...
      <div class="mt-8">
        <div class="ml-3 text-gray-700">
          <div
            class
          >Je suis mis en contact avec une personne isolée par le biais d’une association ou d’un organisme public :</div>
          <ul class="my-3">
            <li>- j’échange avec la personne, prends de ses nouvelles ;</li>
            <li>- je fais remonter des alertes aux structures, si je le juge nécessaire, sur l’état de santé – mentale ou physique – et les besoins exprimés de la personne contactée.</li>
          </ul>
          <div
            class="mt-3"
          >Lorsque je m’engage à prendre contact avec des personnes âgées, en situation de handicap, en situation de pauvreté, de précarité, ou d’isolement, je m’engage à suivre les recommandations précisées dans les kits de formation.</div>
